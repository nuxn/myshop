...
{
	var upurl ='index.php?g=Merchants&m=Uploadify&a=upload&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
...
function GetUploadify4(num,elementid,path,callback)
{
    var upurl ='index.php?g=Merchants&m=Uploadify&a=upload&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
    var iframe_str='<iframe frameborder="0" ';
    iframe_str=iframe_str+'id=uploadify ';
...
function GetUploadify5(num,elementid,path,callback)
{
    var upurl ='index.php?g=Merchants&m=Uploadify&a=upload&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
    var iframe_str='<iframe frameborder="0" ';
    iframe_str=iframe_str+'id=uploadify ';
...
function ClearPicArr(val)
{
	$("li[rel='"+ val +"']").remove();
	$.get(
		"{:U('Merchants/Uploadify/delupload')}",{action:"del", filename:val},function(){}
	);
}
/*
 * 删除组图input
