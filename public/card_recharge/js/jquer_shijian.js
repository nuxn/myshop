    	...
    	function cPlugin(o,emlnum){
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            strEnd:function(){
		                var df=this;
		                return "</ul><div class='G-bg'><div class='G-top' style='height:"+(df.height*2)+"px'></div><div class='G-mid' style='height:"+df.height+"px;border-bottom: 1px solid #d8dee6;border-top: 1px solid #d8dee6'></div><div class='G-btm' style='height:"+(df.height*2)+"px'></div></div></div>"
		            },
		            //数字小于10 就在字前面+一个0
		            fillZero:function(x){
		                if(x<10){
