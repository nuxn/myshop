...
//    const MCHID = '107584000030001';
    //进件的KEY
    const APPLY_KEY = 'TYUjiuytnhgyuiytresdxcvbnmjkiuyt';
    //交易默认的KEY
...
//    const NATIVEPAY_QUERYORDER = 'https://test-svrapi.webank.com/l/wbap-bbfront/ngos';
    ...
    //=======【证书路径设置】=====================================
    //证书路径,注意应该填写绝对路径
    const SSLCERT_PATH = '/nasdata/www/youngshop/simplewind/Core/Library/Vendor/Wzpay/cert/apiclient_cert.pem';
    const SSLKEY_PATH = '/nasdata/www/youngshop/simplewind/Core/Library/Vendor/Wzpay/cert/apiclient_key.pem';
...
//    const CALLBACK_URL = 'https://sy.youngport.com.cn/index.php?s=Pay/Barcode/index';
    ...
    //退款接口
//    const PAY_BACK = 'https://test-svrapi.webank.com/l/wbap-bbfront/nro';
    const PAY_BACK = 'https://svrapi.webank.com/wbap-bbfront/nro';
    //=======【异步通知url设置】===================================
