<?php
if(file_exists(__DIR__."/../../../data/conf/db.php")){
	$db=include __DIR__."/../../../data/conf/db.php";
}else{
	$db=array();
}
if(file_exists(__DIR__."/../../../data/conf/config.php")){
	$runtime_config=include __DIR__."/../../../data/conf/config.php";
}else{
    $runtime_config=array();
}
if (file_exists(__DIR__."/../../../data/conf/route.php")) {
    $routes = include __DIR__."/../../../data/conf/route.php";
} else {
    $routes = array();
}
...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Message','Merchants','Apiscreen','App','Xcx','Post','Wechat'),
...
//            'APPSECRET'          => '6b6a7b6994c220b5d2484e7735c0605a',  //公众帐号secert
            'APPSECRET'          => '3fa1c129be3bcbca0dcda28465d361a1',  //公众帐号secert
