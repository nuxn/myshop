...
var_dump($info);
        ...
        $return_data['url'] =C('_WEB_UPLOAD_').$info['upfile']['savepath'].$info['upfile']['savename'];
        $return_data['url2'] =$info['upfile']['savepath'].$info['upfile']['savename'];
        $return_data['title'] = $title;
        $return_data['original'] = $info['upfile']['name'];
        $return_data['states'] = $state;
